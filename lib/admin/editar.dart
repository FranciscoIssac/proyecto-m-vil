...
class Editar extends StatefulWidget {
  ...
  const Editar({required this.hotel, Key? key}) : super(key: key);
...
class _EditarState extends State<Editar> {
  ...
  late TextEditingController availavilityS;
  late TextEditingController availavilityD;
  late TextEditingController priceS;
  late TextEditingController priceD;

  @override
  void initState() {
    print(widget.hotel);
    super.initState();
    hotelName = TextEditingController(text: widget.hotel['name']);
    description = TextEditingController(text: widget.hotel['description']);
    location = TextEditingController(text: widget.hotel['location']);
    telephone = TextEditingController(text: widget.hotel['telephone']);
    availavilityS = TextEditingController(text: widget.hotel['availavilityS'].toString());
    availavilityD = TextEditingController(text: widget.hotel['availavilityD'].toString());
    priceS = TextEditingController(text: widget.hotel['priceS'].toString());
    priceD = TextEditingController(text: widget.hotel['priceD'].toString());
  }
                      ...
                      onPressed: () async {
                        if (hotelName.text.isEmpty ||
                          ...
                          Map<String, dynamic> row = {
                            HotelTableHelper.columnId: widget.hotel['_id'],
                          ...
                          final id = await hotelDBHelper.update(row);
